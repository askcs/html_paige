...
function AdminSession(sKey) {
	this.sessionKey = localStorage["adminSessionKey"];
	this.appServices = localStorage["adminAppServices"];
...
AdminSession.prototype.isLogin = function() {
	return (this.sessionKey != null && this.sessionKey != "");
}

AdminSession.prototype.setSessionKey = function(sKey) {
	this.sessionKey = sKey;
	localStorage.setItem("adminSessionKey", sKey);
}

AdminSession.prototype.authenticator = function(){
	if(!this.isLogin()){
...
PaigeData.prototype.get = function(restPath, data, callback) {
	...
	$.Read(admin_session.appServices + restPath, data, {
